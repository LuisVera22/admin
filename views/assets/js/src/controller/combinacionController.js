class CombinacionController{
    constructor(model,view){
        ...
        window.eliminarCombinacion = this.eliminarCombinacion.bind(this);
        window.reingresarCombinacion = this.reingresarCombinacion.bind(this);
    }

    onCreateCombinacionFormSubmit(){
        const $datos = this.view.formRegistrarCombinacion.serialize();
        const self = this;
        $.ajax({
            ...
            dataType: 'json',
            beforeSend: function () {
                $("#frmRegistrarCilEsfAdd #spinnerButton").show();
                $("#frmRegistrarCilEsfAdd #btnCombinacion").attr("disabled", true);
            },
            success: function (e) {
                if (e.responseJson == "no server") {
                    ...
                    if (e.message == "Unauthenticated.") {
                        ...
                        if (e.message == "Registro Generado.") {
                            ...
                            self.tblListCombinacion.ajax.reload();
                            $("#frmRegistrarCilEsfAdd")[0].reset();
                            $("#frmRegistrarCilEsfAdd #selectEsf").val(null).trigger('change');
                            $("#frmRegistrarCilEsfAdd #selectCil").val(null).trigger('change');
                            $("#frmRegistrarCilEsfAdd #selectAdd").val(null).trigger('change');
                        } else {
            ...
            error: function (error) {
                ...
                $("#frmRegistrarCilEsfAdd #btnCombinacion").removeAttr("disabled");
                $("#frmRegistrarCilEsfAdd #spinnerButton").hide();
            },
        }).done(function () {
            $("#frmRegistrarCilEsfAdd #btnCombinacion").removeAttr("disabled");
            $("#frmRegistrarCilEsfAdd #spinnerButton").hide();
    ...
    listCombinacion(){
        this.tblListCombinacion = $('#tblListCombinacion').DataTable({
            ordering: false,
            stateSave: true,
            language: {
            ...
            ajax: {
                url: "json/ajax_combinacion/listarCombinacion.php",
                dataSrc: ''
            },
            responsive: true,
            columnDefs: [
    ...
    eliminarCombinacion(param){
        const self = this;
        Swal.fire({
            title: 'Estás seguro en eliminar?',
            text: "Se inactivará la combinacion seleccionado",
            icon: 'warning',
                    ...
                    if (e.responseJson == "no server") {
                        ...
                        if (e.message == "Unauthenticated.") {
                            ...
                            if (e.message == "Eliminación exitosa") {
                                Swal.fire(
                                    'Eliminado',
                                    'La combinacion paso a Inactivo',
                                    'success'
                                );
                                self.tblListCombinacion.ajax.reload();
                            }
    ...
    reingresarCombinacion(param){
        const self = this;
        Swal.fire({
            title: 'Estás seguro en reintegrar?',
            text: "Se reintegrará la combinacion seleccionado",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
