<section class="container-fluid py-4">
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            <div class="table-responsive">
                <table id="tblListSedes" class="table table-flush table-hover" width="100%">
    ...
    <form class="formularios" id="frmRegistrarSede" method="post" autocomplete="off">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title text-uppercase fs-5" id="agregarLabel">Registro Sede</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline-success btn-sm" id="btnSedes">
    ...
    <div>
        <form class="formularios" id="frmActualizarSede" method="post" autocomplete="off">
            <div class="modal fade" id="actualizar-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="actualizarLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title text-uppercase fs-5" id="actualizarLabel">Actualizar Sede</h1>
                            <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary btn-sm btnCerrar" data-bs-dismiss="modal">Cerrar</button>
                            <button type="submit" class="btn btn-outline-info btn-sm" id="btnSedes">
                                <span class="spinner-border spinner-border-sm" id="spinnerButton" role="status" aria-hidden="true" style="width: 1rem;height: 1rem;display: none;">
...
<script src="views/assets/js/src/model/sedesModel.js"></script>
<script src="views/assets/js/src/controller/sedesController.js"></script>
<script src="views/assets/js/src/view/sedesView.js"></script>
<script src="views/assets/js/src/app/sedesApp.js"></script>