<section class="container-fluid py-4">
        ...
        <div class="collapse" id="collapseFiltro">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label id="filtroFactura" class="form-label">Factura:</label>
                            <input type="text" class="form-control" placeholder="Factura" data-index="2" id="filtroFactura">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
    ...
    <div class="d-flex m-3">
        <div class="ms-auto d-flex" style="margin-left: 0!important;">
            <a href="nota-credito" class="btn btn-outline-info text-info">
                <i class="fas fa-book-open me-2"></i> Nota Crédito
            </a>
        </div>
    </div>
