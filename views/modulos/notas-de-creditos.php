        ...
        <div class="collapse" id="collapseFiltro">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label id="filtroNotaCredito" class="form-label">Nota de Crédito:</label>
                            <input type="text" class="form-control" placeholder="Nota de Crédito" data-index="2" id="filtroNotaCredito">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
