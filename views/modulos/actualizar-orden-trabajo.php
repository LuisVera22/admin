<section class="container-fluid py-4" style="overflow-x: hidden;">
    ...
    <div class="d-flex pb-4">
        ...
        <div class="ms-3">
            <h4>Actualizar Orden de Trabajo</h4>
        </div>
    </div>
    <div class="card shadow-lg" id="encabezado_actaulizar_orden">
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date textEmision">
                                    <input type="text" class="form-control" name="textEmision" id="textEmision" required>
                ...
                <div class="col-12">
                    <div class="d-flex mt-3">
                        <div class="ms-auto d-flex">
                            ...
                            <div class="ps-4">
                                <a href="ordenes-trabajo" class="btn btn-outline-secondary btn-sm" id="btn_cancelar">Cerrar</a>
                            </div>
                            <div class="ps-4">
                                <button type="button" class="btn btn-outline-info btn-sm" id="btnUpdateOrdenTrabajo">
                                    Actualizar
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="textDetalleProducto" id="textDetalleProducto" placeholder="Detalle del Producto">
                                        </div>
                                        ...
                                        <div class="col-12" id="mostrar_parametros_udt">
                                            ...
                                            <div>
                                                <div class="form-check align-content-center">
                                                    ...
                                                    <label class="form-check-label" for="CheckAlturas">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-check align-content-center">
                                                        ...
                                                        <label class="form-check-label" for="CheckDips">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-check align-content-center">
                                                        ...
                                                        <label class="form-check-label" for="CheckDiametro">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control" name="numberMonto" id="numberMonto" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
...
<script src="views/assets/js/src/model/ordentrabajoUdtModel.js"></script>
<script src="views/assets/js/src/controller/ordentrabajoUdtController.js"></script>
<script src="views/assets/js/src/view/ordentrabajoUdtView.js"></script>
<script src="views/assets/js/src/app/ordentrabajoUdtApp.js"></script>