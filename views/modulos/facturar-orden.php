<section class="container-fluid py-4" style="overflow-x: hidden;">
    ...
    <div class="d-flex pb-4">
        ...
        <div class="ms-3">
            <h4>Facturar Orden de Trabajo</h4>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div>
                        <div class="form-group">
                            <label for="selectTipoManuf" class="form-label">Tipo Manufacturación:</label>
                            <select class="form-select select2Busqueda" id="selectTipoManuf" name="selectTipoManuf" required>
...
<script src="views/assets/js/src/model/facturacionModel.js"></script>
<script src="views/assets/js/src/controller/facturacionController.js"></script>
<script src="views/assets/js/src/view/facturacionView.js"></script>
<script src="views/assets/js/src/app/facturacionApp.js"></script>